...
- **依赖**: Task-101 ✅
- **验收标准**:
  - [ ] 默认预加载前 30s 音频（可配置 10/30/60s）
  - [ ] 首帧快速窗：前 5–10s 并行抽取与识别
  - [ ] 首帧字幕可见时间 P95 < 5s（短视频）
  - [ ] 音频抽取服务实现（AudioExtractor）
  - [ ] 内存与缓存基础策略
...
- **详细设计**: `task-107-metrics-diagnostics-minimal.md`
- **技术要点**:
  - OSLog 子系统与分类
...
| 日期 | 剩余 SP | 完成 SP | 备注 |
|------|---------|---------|------|
| D1 (10-30) | 40 | 0 | Sprint 启动 |
| D3 (10-30) | 35 | 5 | Task-101 完成 |
| D3 (10-30) | 35 | 5 | Task-102 开始（进行中 8 SP） |
| ... | ... | ... | 待更新 |
