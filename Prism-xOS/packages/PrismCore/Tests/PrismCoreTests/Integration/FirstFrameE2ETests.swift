...
final class FirstFrameE2ETests: XCTestCase {
    ...
    private func createTestAudioAsset(duration: TimeInterval, sampleRate: Double = 44_100) throws
        -> AVAsset {
        // 创建临时文件
    ...
    func testGetFirstFrameBuffer_Success() async throws {
        ...
        print("   数据量: \(String(format: "%.2f", Double(buffer.sizeInBytes) / 1_024.0)) KB")
    }
